...
export class SecurityMonitor {
  ...
  private async fetchGitHubAdvisories(): Promise<any[]> {
    try {
  ...
  private async fetchRustSecurity(): Promise<any[]> {
    try {
  ...
  private createGitHubRules(advisories: any[]): Rule[] {
    return advisories
  ...
  private createCVERules(cveData: any[]): Rule[] {
    return cveData
  ...
  private createRustSecurityRules(rustData: any[]): Rule[] {
    return rustData
  ...
  private getDefaultSecurityRules(): Rule[] {
    return [
      {
        id: 'SEC-001',
        category: 'Security',
