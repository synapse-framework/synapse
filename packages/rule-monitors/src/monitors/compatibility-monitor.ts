...
export class CompatibilityMonitor {
  ...
  private async fetchBrowserSupport(): Promise<any[]> {
    try {
  ...
  private async fetchNodeVersions(): Promise<any[]> {
    try {
  ...
  private async fetchRustEditions(): Promise<any[]> {
    try {
  ...
  private createBrowserRules(data: any[]): Rule[] {
    return [
      {
  ...
  private createNodeRules(data: any[]): Rule[] {
    return [
      {
        id: 'COMPAT-NODE-001',
        category: 'Compatibility',
  ...
  private createRustRules(data: any[]): Rule[] {
    return [
      {
        id: 'COMPAT-RUST-001',
        category: 'Compatibility',
  ...
  private getDefaultCompatibilityRules(): Rule[] {
    return [
      {
        id: 'COMPAT-001',
        category: 'Compatibility',
