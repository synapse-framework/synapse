export class PerformanceMonitor {
    ...
    async fetchLighthouseStandards() {
        try {
    ...
    async fetchPerformanceStandards() {
        try {
    ...
    createPerformanceRules(data) {
        return [];
    }
    getDefaultPerformanceRules() {
        return [
            {
                id: 'PERF-001',
                category: 'Performance',
