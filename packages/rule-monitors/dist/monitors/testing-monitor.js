export class TestingMonitor {
    ...
    createTestPatternRules(data) {
        return [];
    }
    getDefaultTestingRules() {
        return [
            {
                id: 'TEST-001',
                category: 'Testing',
...
//# sourceMappingURL=testing-monitor.js.map